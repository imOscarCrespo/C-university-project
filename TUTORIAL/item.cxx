...
typedef std::list<Item*> Items; //Declaració d'una llista anomenada Locations de tipus Animal(super-classe)

int main(void){
        
    Items items;  //Creació d'una instancia animals de tipus Animals
